...
class Dlister {
	...
	constructor() {
		...
		this.flags = {// TODO add stackoverflow tag for padding on left side
			add : {
				exp : "--a",
		...
		this.flagKeys = Object.keys(this.flags);//JSON.parse(fs.readFileSync(configFile));
...
// console.log(lister.readIgnores(configFile));
